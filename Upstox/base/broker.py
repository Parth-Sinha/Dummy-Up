...
from Upstox.base.errors import RequestTimeout
from Upstox.base.errors import NetworkError
...
class Broker:
    ...
    def jsonify_expiry(
        ...
        """
        Creates a Upstox Unified Dicitonary for BankNifty & Nifty Options,
        ...
        Parameters:
            data_frame (DataFrame): DataFrame to Convert to Upstox Unified Expiry Dictionary
